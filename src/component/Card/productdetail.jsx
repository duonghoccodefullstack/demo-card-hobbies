...
const ProductDetail = ({ value, onClose }) => {
    ...
    return (
        <div>
            <div className="relative -top-[100vw] left-50 bg-black w-[100vw] h-[2275px] p-2 opacity-10">

            </div>
            <div className='mx-20 my-20 px-10 absolute top-0 w-[70w] bg-white rounded-lg'>
